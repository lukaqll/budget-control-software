        ...
        <!-- form start -->
          ...
          <div class="box-body">
           ...
           <ul class="list-group">
              ...
              <li class="list-group-item" style="width: 400px" ><!--  <img src="/<?php echo htmlspecialchars( $value1["dir"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="mr-3" style="width: 30px;"> --> <?php echo getNomeDir($value1["dir"]); ?> <a href="/<?php echo htmlspecialchars( $value1["dir"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="fa fa-download pull-right" target="_blank"></a> <a href="/index.php/orc/product/deletearq/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/"  class="fa fa-trash pull-right"></a></li>
              <?php } ?>
