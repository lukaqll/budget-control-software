  	...
  	<div class="col-md-12">
        ...
        <!-- form start -->
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-md-3 col-sm-3">
                ...
                <select tabindex="-1" id="prioridade" id="prioridade" name="prioridade" class="form-control">
                 ...
                 <input tabindex="-1" type="num"  id="price" name="price" step='0.01' placeholder="R$" class="form-control" value="<?php echo htmlspecialchars( $product["price"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
              </div>
                ...
                <input type="hidden" name="cod" value="<?php echo htmlspecialchars( $product["cod"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                 ...
                 <label style="margin-top: 10px">Pagamento</label>
                  <select tabindex="-1" id="pago" id="pago" name="pago" class="form-control">
                    ...
                    <option value="(2)Pago">Pago</option>
                  </select>
            ...
            <label>Arquivos</label><span data-tooltip="Os arquivos estão localizados na pasta 'arquivos'. você pode baixá-los novamente para outra pasta de sua escolha."><b class="obs">!</b></span><br>
           ...
           <ul>
              ...
              <li><?php echo htmlspecialchars( $value1["dir"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <a href="/<?php echo htmlspecialchars( $value1["dir"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="fa fa-download" target="_blank"></a> <a href="/index.php/orc/product/deletearq/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/"  class="fa fa-trash"></a></li>
              <?php } ?>
          ...
          <input type="file" name="dir">
            ...
            <div class="row container">
              ...
              <div class="col-6 col-md-2" style="margin-left: -30px;"><label id="lbvalortotal" class="form-control">Total R$ <?php echo htmlspecialchars( $valortotal, ENT_COMPAT, 'UTF-8', FALSE ); ?></label></div>
            </div> 
          ...
          <div class="box-footer">
           ...
           <a href="/index.php/orc/products/dtregister" class="btn btn-primary">Voltar</a>
